...
for i4 in range(len4):
    ...
    if label1[i4] == 4:
        countE = countE + 1
        if countD == 1:
            plt.scatter(linelabel, E2[i4], color='black', linewidth=1.0, label='类别4')
        else:
            plt.scatter(linelabel, E2[i4], color='black', linewidth=1.0)
