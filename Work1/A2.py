...
A = pd.read_excel(r'D:\Program Files\JetBrains\PyCharmFile\Work1\2017年行业产增表.xlsx', sheet_name="Sheet1", header=0)
B = np.array(A)             # 将产增数据转化为矩阵格式
C1 = B[0:, 1:]              # 取矩阵中相应的数据
C2 = C1.T                   # 转置

ax = pd.read_excel(r'D:\Program Files\JetBrains\PyCharmFile\Work1\A2.xlsx', sheet_name="Sheet2", header=0)
...
# print(result3)
result4 = np.delete(result3, 0, axis=0)               # 删除第一行
